        ...
        template = `
            <div  class='col-md-12 table-fixed'>
                <div class='row'>
                    ...
                    <div class='col-6'>
                       <h6> Estado 
                            <span class="badge badge-pill badge-${res.color}">${res.status} 
                            </span> 
                        <a onclick="changeStatusOrder('${res.type_profile}')"> Cambiar </a></h6>
                    </div>
                </div>
                <hr>
                <div class='row'>  
...
function changeStatusOrder(values) {
    alert(values)
}
...
function changeUploadImage(type) {
    switch (type) {
        case "upload-file":
            $(".image-product").prop({"type": "file", "disabled": false});
            break;
        case "url":   
            var temp = $("#img-temp").val();
            $(".image-product").prop({"type": "text", 
                "value": temp, "disabled": false, "placeholder": "Pega una url de imagen"});
            break;
        case "default":
        default:
            $(".image-product").prop({"value": "", "type": "text", "disabled": "true", "placeholder": "Imagen por defecto del sistema"});
            //$(".image-product").prop("type", "text");
            //alert(type);
            break;
    }
