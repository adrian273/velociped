                        ...
                        <div class="collapse navbar-collapse"
                            ...
                            <ul class="nav navbar-nav flex-grow-1 justify-content-between">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" 
                                       href="<%=request.getContextPath()%>/producto?action=prod&category=bicicletas">
                                        Bicicletas
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" 
                                       href="<%=request.getContextPath()%>/producto?action=prod&category=accesorios">
                                        Accesorios
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" 
                                       href="<%=request.getContextPath()%>/producto?action=prod&category=componentes">
                                        Componentes
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" 
                                       href="<%=request.getContextPath()%>/producto?action=prod&category=indumentaria">
                                        Indumentaria
                                    </a>
                                </li>
